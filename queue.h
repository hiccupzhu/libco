...
#ifndef __INCLUDE_LIBCO_QUEUE_H
#define __INCLUDE_LIBCO_QUEUE_H
...
static inline void sq_addafter(FAR sq_entry_t *prev,
    FAR sq_entry_t *node,
...
static inline void dq_addafter(FAR dq_entry_t *prev,
    FAR dq_entry_t *node,
...
static inline FAR dq_entry_t *dq_remafter(FAR dq_entry_t *node,
    FAR dq_queue_t *queue)
{
